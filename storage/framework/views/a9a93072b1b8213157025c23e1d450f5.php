                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                               ...
                               <h3 style="color: white">Sistema de Expediente</h3>
                            </a>
                        </div>
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                <h5 class="text-primary">Ingresar!</h5>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3">
                                        <div class="float-end">
                                            <a href="<?php echo e(route('password.update')); ?>" class="text-muted">Olvido contraseña?  </a>
                                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> Sistema de Expediente</p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Borys\Documents\MosquedaCordova\corporate\resources\views/auth/login.blade.php ENDPATH**/ ?>