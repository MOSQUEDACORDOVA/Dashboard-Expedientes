...
<body>
    ...
    <table style="margin-left: 35px;">
        ...
        <tr>
            <td>Finalidad</td>
            <td>:</td>
            <td class="highlight-red"><?php echo e($expediente->finalidad); ?> CONFIRMAR VALOR</td>
        </tr>
        <tr>
    ...
    <div class="content">
        ...
        <ol type="I">
           ...
           ?>
            ...
            <p><?php echo e($expediente->razon_social); ?>, inscrita en la Partida Electrónica N° <?php echo e($expediente->Cliente->partida_promotor); ?> del Registro de Personas Jurídicas de <?php echo e($expediente->Cliente->sunarp); ?>.</p>
            ...
            <p>Gerente General: <?php echo e($expediente->Cliente->rep_legal); ?> identificado con  N°«DNI_Representante_Legal_1». </p>
            ...
            <div style="margin-top:7px;">
                <?php $__currentLoopData = $expediente->inmuebles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $inmueble): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label style="vertical-align: middle;">
                        <input type="checkbox" style="vertical-align: middle;"> CRI de la partida electrónica Nº <?php echo e($inmueble->partida); ?> del Registro de Propiedad Inmueble de la Oficina Registral de.<?php echo e($inmueble->sunarp); ?>.
            ...
            <p>RESPECTO AL INMUEBLE: <br>
                <?php echo e($expediente->evaluacion->respecto_inmueble); ?>

            </p>

            <p>RESPECTO DEL CLIENTE O LA OPERACION: <br>
                <?php echo e($expediente->evaluacion->respecto_cliente_opera); ?>

            </p>

            <p>RESPECTO A LA MINUTA DE COMPRAVENTA: <br>
                <?php echo e($expediente->evaluacion->respecto_minu_compr_v); ?>

            </p>

            <p>RESPECTO DE LA MINUTA DE COMPRAVENTA DE BIEN FUTURO: <br>
                <?php echo e($expediente->evaluacion->respecto_minu_compr_v_futu); ?>

            </p>

            <p>RESPETO DE LOS FIADORES: <br>
                <?php echo e($expediente->evaluacion->respecto_fiador); ?>
