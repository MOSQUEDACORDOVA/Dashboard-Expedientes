<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.crear-facturacion'); ?>
...
<div class="row">
    <div class="col-xxl-12">
      ...
      <form id="multiStepForm" action="<?php echo e(route('facturacion.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                ...
                <div class="tab-content text-muted">
                    <div class="tab-pane active" id="expediente" role="tabpanel">
                        ...
                        <form id="expedienteForm">
                            ...
                            <div class="col-lg-12">
                                <label for="departamentoPromotor" class="form-label">Tipo</label>
                                <select style="    border-radius: 0px !important;" class="form-select rounded-pill mb-3" id="departamentoPromotor" name="departamentoPromotor" value="" aria-label="Default select example" onchange="cambiarProvincias()">
                            ...
                            <div class="col-xxl-12 col-md-12 mb-2">
                                <div>
                                    ...
                                    <?php $__currentLoopData = $traerIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $trazerId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($id); ?>"><?php echo e($trazerId); ?></option>
...
<?php echo $__env->make("layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\sistemaexpediente\resources\views/formulario-facturacion.blade.php ENDPATH**/ ?>