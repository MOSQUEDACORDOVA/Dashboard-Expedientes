                        ...
                        <h4 class="card-title mb-4 flex-grow-1">Ingresar los datos verificados para la correcta elaboración del Informe para garantía</h4>
                            ...
                            <div class="col-xxl-12 col-md-12">
                                <div>
                                    ...
                                    <input type="text" class="form-control" id="dni_rep_legal" name="dni_rep_legal" value="<?php echo e($expediente->Cliente->dni_rep_legal); ?>">
                                </div>
                            </div>
                            <div class="col-xxl-12 col-md-12">
                                <div>
                                 ...
                                 color: black; cursor:pointer;
                                    ...
                                    <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                                        <div class="form-check">
                                            ...
                                            <?php echo e(is_array($poderesSeleccionados) && in_array('Contratos de créditos en general', $poderesSeleccionados) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                                        <div class="form-check">
                                            ...
                                            <?php echo e(is_array($poderesSeleccionados) && in_array('Solicitar, contratar y otorgar fianzas', $poderesSeleccionados) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                                        <div class="form-check">
                                            ...
                                            <?php echo e(is_array($poderesSeleccionados) && in_array('Compra y venta de bienes muebles e inmuebles y valores mobiliarios', $poderesSeleccionados) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                                        <div class="form-check">
                                            ...
                                            <?php echo e(is_array($poderesSeleccionados) && in_array('Hipotecar', $poderesSeleccionados) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                                        <div class="form-check">
                                            ...
                                            <?php echo e(is_array($poderesSeleccionados) && in_array('Prendar y otorgar garantías inmobiliarias', $poderesSeleccionados) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                                        <div class="form-check">
                                            ...
                                            <?php echo e(is_array($poderesSeleccionados) && in_array('Afectar títulos valores en garantía', $poderesSeleccionados) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                                        <div class="form-check">
                                            ...
                                            <?php echo e(is_array($poderesSeleccionados) && in_array('Endose pólizas de seguros', $poderesSeleccionados) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                                        <div class="form-check">
                                            ...
                                            <?php echo e(is_array($poderesSeleccionados) && in_array('Consorcios', $poderesSeleccionados) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                                        <div class="form-check">
                                            ...
                                            <?php echo e(is_array($poderesSeleccionados) && in_array('Suscribir, constituir fideicomiso en garantía y transferir en dominio fiduciario bienes y/o flujos', $poderesSeleccionados) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                                        <div class="form-check">
                                            ...
                                            <?php echo e(is_array($poderesSeleccionados) && in_array('Otorgar poder Irrevocable', $poderesSeleccionados) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                                        <div class="form-check">
                                            ...
                                            <?php echo e(is_array($poderesSeleccionados) && in_array('Cesión de posición contractual', $poderesSeleccionados) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                                        <div class="form-check">
                                            ...
                                            <?php echo e(is_array($poderesSeleccionados) && in_array('Otros', $poderesSeleccionados) ? 'checked' : ''); ?>>
                ...
                <div class="col-xxl-6 col-lg-6 col-md-6 mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="formCheck22_<?php echo e($index); ?>" name="inmuebles[<?php echo e($index); ?>][cargas][0]" value="Ninguno"
                            <?php echo e(is_array($cargacc2) && in_array('Ninguno', $cargacc2) ? 'checked' : ''); ?>>
                ...
                <div class="col-xxl-6 col-lg-6 col-md-6 mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="formCheck23_<?php echo e($index); ?>" name="inmuebles[<?php echo e($index); ?>][cargas][1]" value="Con Carga"
                            <?php echo e(is_array($cargacc2) && in_array('Con Carga', $cargacc2) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xxl-6 col-lg-6 col-md-6 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="formCheck24_<?php echo e($index); ?>" name="inmuebles[<?php echo e($index); ?>][gravamenes][0]" value="Sin Gravamen"
                                    <?php echo e(is_array($gravamenes) && in_array('Sin Gravamen', $gravamenes) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xxl-6 col-lg-6 col-md-6 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="formCheck25_<?php echo e($index); ?>" name="inmuebles[<?php echo e($index); ?>][gravamenes][1]" value="Con Gravamen"
                                    <?php echo e(is_array($gravamenes) && in_array('Con Gravamen', $gravamenes) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xxl-6 col-lg-6 col-md-6 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="formCheck26_<?php echo e($index); ?>" name="inmuebles[<?php echo e($index); ?>][tpendientes][0]" value="Ninguno"
                                    <?php echo e(is_array($tpendientesres) && in_array('Ninguno', $tpendientesres) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xxl-6 col-lg-6 col-md-6 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="formCheck27_<?php echo e($index); ?>" name="inmuebles[<?php echo e($index); ?>][tpendientes][1]" value="Con título pendiente"
                                    <?php echo e(is_array($tpendientesres) && in_array('Con título pendiente', $tpendientesres) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="formCheck31" name="DOCUMENTOSRE[1]" value="HR y PU 2024"
                                    <?php echo e(is_array($docre) && in_array('HR y PU 2024', $docre) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="formCheck32" name="DOCUMENTOSRE[2]" value="Recibo de pago de impuestos municipales correspondientes al año 2024"
                                    <?php echo e(is_array($docre) && in_array('Recibo de pago de impuestos municipales correspondientes al año 2024', $docre) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="formCheck33" name="DOCUMENTOSRE[3]" value="Aplicativo de poderes del cliente"
                                    <?php echo e(is_array($docre) && in_array('Aplicativo de poderes del cliente', $docre) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="formCheck34" name="DOCUMENTOSRE[4]" value="Informe de tasación"
                                    <?php echo e(is_array($docre) && in_array('Informe de tasación', $docre) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="formCheck35" name="DOCUMENTOSRE[5]" value="Vigencia de poder de representante del cliente"
                                    <?php echo e(is_array($docre) && in_array('Vigencia de poder de representante del cliente', $docre) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="formCheck36" name="DOCUMENTOSRE[6]" value="DNI del representante del cliente"
                                    <?php echo e(is_array($docre) && in_array('DNI del representante del cliente', $docre) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="formCheck37" name="DOCUMENTOSRE[7]" value="DNI del/ los propietario(s)"
                                    <?php echo e(is_array($docre) && in_array('DNI del/ los propietario(s)', $docre) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="formCheck38" name="DOCUMENTOSRE[8]" value="Modelo de Minuta de Compraventa de Bien futuro"
                                    <?php echo e(is_array($docre) && in_array('Modelo de Minuta de Compraventa de Bien futuro', $docre) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-xxl-12 col-lg-4 col-md-12 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="formCheck39" name="DOCUMENTOSRE[9]" value="Otros"
                                    <?php echo e(is_array($docre) && in_array('Otros', $docre) ? 'checked' : ''); ?>>
...
<?php echo $__env->make("layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Borys\Documents\MosquedaCordova\corporate\resources\views/expedientes/editar.blade.php ENDPATH**/ ?>