        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
               ...
               <!--  <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="/nuevo-expediente">
                <button type="button" class="btn btn-success waves-effect waves-light">NUEVO EXPEDIENTE +</button></a>
                </li>

                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'Administrador')): ?>
                <li class="nav-item">
                    <a class="nav-link" href="usuarios">
                        <i class="ri-honour-line"></i> <span>Usuarios</span>
                    </a>
                </li>
                <?php endif; ?>
               
                <li class="nav-item">
                    <a class="nav-link menu-link" href="/lista-expediente">
                        <i class="ri-honour-line"></i> <span>Expedientes</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link menu-link" href="/lista-facturacion">
                        <i class="ri-honour-line"></i> <span>Facturación</span>
                    </a>
                </li>

               <!-- <li class="nav-item">
                    <a class="nav-link menu-link" href="/lista-expediente">
                        <i class="ri-honour-line"></i> <span>Notaria</span>
                    </a>
                </li>-->
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#">
                        <i class="ri-honour-line"></i> <span>Estadísticas</span>
                    </a>
                </li>
                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'Administrador')): ?>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#Mante" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAdvanceUI">
                        <i class="ri-stack-line"></i> <span>Mantenimiento</span>
                    </a>
                    <div class="collapse menu-dropdown" id="Mante">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="actividad-actual" class="nav-link"> Actividad actual</a>
                            </li>
                            <li class="nav-item">
                                <a href="departamento" class="nav-link">Departamentos</a>
                            </li>
                            <li class="nav-item">
                                <a href="detraccion" class="nav-link"> Detracción</a>
                            </li>
                            <li class="nav-item">
                                <a href="estado" class="nav-link"> Estado </a>
                            </li>
                            <li class="nav-item">
                                <a href="estado-civil" class="nav-link"> Estado civil</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="oficina-registral" class="nav-link"> Oficina registral</a>
                            </li>
                            <li class="nav-item">
                                <a href="tasador" class="nav-link">Tasador</a>
                            </li>
                            <li class="nav-item">
                                <a href="tipo" class="nav-link">Tipo</a>
                            </li>
                        </ul>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarIcons">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="icons-boxicons" class="nav-link"><span><?php echo app('translator')->get('translation.boxicons'); ?></span><span class="badge badge-pill bg-info">v3.5</span></a>
                            </li>
                            <li class="nav-item">
                                <a href="icons-materialdesign" class="nav-link"><span><?php echo app('translator')->get('translation.material-design'); ?></span><span class="badge badge-pill bg-info">v3.5</span></a>
                            </li>
                            <li class="nav-item">
                                <a href="icons-lineawesome" class="nav-link"><?php echo app('translator')->get('translation.line-awesome'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a href="icons-feather" class="nav-link"><span><?php echo app('translator')->get('translation.feather'); ?></span><span class="badge badge-pill bg-info">v3.5</span></a>
                            </li>
                            <li class="nav-item">
...
<?php /**PATH C:\Users\Borys\Documents\MosquedaCordova\corporate\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>