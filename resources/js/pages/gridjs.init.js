...
if (document.getElementById("table-gridjs")) {
    // Realiza la solicitud para obtener los datos de expedientes
    fetch('/expedientes')
        .then(response => response.json())
        .then(data => {
            // Convierte los datos en un formato adecuado para Grid.js
            const gridData = data.map(expediente => [
                expediente.id,
                expediente.razon_social,
                expediente.correo_funcionario,
                expediente.finalidad,
                expediente.funcionario,
                expediente.correo_asistente
            ]);

            // Inicializa Grid.js con los datos obtenidos
            new gridjs.Grid({
                columns: [
                    {
                        name: 'IDA',
