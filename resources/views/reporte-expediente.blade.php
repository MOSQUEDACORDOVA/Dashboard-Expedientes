...
<body>
    ...
    <table style="margin-left: 35px;">
        ...
        <tr>
            <td>Finalidad</td>
            <td>:</td>
            <td class="highlight-red">{!! $expediente->finalidad ?? '<span style="color: red;">NO INDICADO</span>' !!}</td>
        </tr>
        <tr>
        ...
        <p>
            ...
            <div style="margin-top:7px;">
                @foreach($expediente->inmuebles as $index => $inmueble)
                    <label style="vertical-align: middle;">
                        <input type="checkbox" style="vertical-align: middle;"> CRI de la partida electrónica Nº {!! $inmueble->partida ?? '<span style="color: red;">NO INDICADO</span>' !!} del Registro de Propiedad Inmueble de la Oficina Registral de {!! $inmueble->sunarp ?? '<span style="color: red;">NO INDICADO</span>' !!}.
                    </label>
                    <br>
                    <label style="vertical-align: middle;">
